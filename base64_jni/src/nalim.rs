...
#[no_mangle]
pub extern "system" fn encodeConfigSlice_NativeCargo(
    input: *const u8,
    input_size: usize,
    output: *mut u8,
    output_size: usize,
...
#[no_mangle]
pub extern "system" fn encodeSimd_NativeCargo(
    input: *const u8,
    input_size: usize,
    output: *mut u8,
    output_size: usize,
...
#[no_mangle]
pub extern "system" fn decodeConfigSlice_NativeCargo(
    input: *const u8,
    input_size: usize,
    output: *mut u8,
    output_size: usize,
...
#[no_mangle]
pub extern "system" fn decodeSimd_NativeCargo(
    input: *const u8,
    input_size: usize,
    output: *mut u8,
    output_size: usize,
