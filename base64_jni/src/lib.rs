...
#[no_mangle]
pub extern "system" fn Java_com_komanov_jwt_base64_jni_NativeCargo_encodeConfigUrlSafe(
    env: JNIEnv,
    _class: JClass,
    payload: jbyteArray,
) -> jbyteArray {
...
#[no_mangle]
pub extern "system" fn Java_com_komanov_jwt_base64_jni_NativeCargo_encodeConfigSlice1(
    env: JNIEnv,
    _class: JClass,
    payload: jbyteArray,
    size: usize,
...
#[no_mangle]
pub extern "system" fn Java_com_komanov_jwt_base64_jni_NativeCargo_encodeConfigSlice2(
    _env: JNIEnv,
    _class: JClass,
    input: *const u8,
    input_size: usize,
...
#[no_mangle]
pub extern "system" fn Java_com_komanov_jwt_base64_jni_NativeCargo_decodeConfigUrlSafe1(
    env: JNIEnv,
    _class: JClass,
    payload: jbyteArray,
) -> jbyteArray {
...
#[no_mangle]
pub extern "system" fn Java_com_komanov_jwt_base64_jni_NativeCargo_decodeConfigUrlSafe2(
    env: JNIEnv,
    _class: JClass,
    payload: jbyteArray,
) -> jbyteArray {
...
#[no_mangle]
pub extern "system" fn Java_com_komanov_jwt_base64_jni_NativeCargo_decodeConfigUrlSafe3(
    env: JNIEnv,
    _class: JClass,
    payload: jbyteArray,
    size: usize,
...
#[no_mangle]
pub extern "system" fn Java_com_komanov_jwt_base64_jni_NativeCargo_decodeConfigUrlSafe4(
    env: JNIEnv,
    _class: JClass,
    payload: jbyteArray,
    size: usize,
...
#[no_mangle]
pub extern "system" fn Java_com_komanov_jwt_base64_jni_NativeCargo_decodeConfigSliceUrlSafe1(
    env: JNIEnv,
    _class: JClass,
    payload: jbyteArray,
    size: usize,
...
#[no_mangle]
pub extern "system" fn Java_com_komanov_jwt_base64_jni_NativeCargo_decodeConfigSliceUrlSafe2(
    env: JNIEnv,
    _class: JClass,
    payload: jbyteArray,
    size: usize,
...
#[no_mangle]
pub extern "system" fn Java_com_komanov_jwt_base64_jni_NativeCargo_decodeConfigSliceUrlSafe3(
    _env: JNIEnv,
    _class: JClass,
    input: *const u8,
    input_size: usize,
...
#[no_mangle]
pub extern "system" fn Java_com_komanov_jwt_base64_jni_NativeCargo_encodeSimdNative(
    _env: JNIEnv,
    _class: JClass,
    input: *const u8,
    input_size: usize,
...
#[no_mangle]
pub extern "system" fn Java_com_komanov_jwt_base64_jni_NativeCargo_decodeSimdNative(
    _env: JNIEnv,
    _class: JClass,
    input: *const u8,
    input_size: usize,
...
#[no_mangle]
pub extern "system" fn Java_com_komanov_jwt_base64_jni_NativeCargo_decodeSimdInPlaceNative(
    _env: JNIEnv,
    _class: JClass,
    output: *mut u8,
    output_size: usize,
